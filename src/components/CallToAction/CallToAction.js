...
export default function CallToAction({ title, description, ctaPrimaryLabel,
  ctaPrimaryIcon,
  ...
  ctaSecondaryLabel,
    ...
    return (
      <div className="mx-auto flex w-full flex-col gap-6 rounded-lg bg-gray-700 p-12 md:flex-row md:gap-12">
